...
const Modal = () => {
  ...
  const { isOpen, content, confirmLabel } = useSelector((state) => state.modal)
  ...
  return (
    <>
      { isOpen && (
          ...
          <div className="relative bg-white rounded-lg shadow-xl sm:max-w-lg sm:w-full mx-4 my-8 mt-16">
