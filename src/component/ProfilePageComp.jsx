    ...
    try {
      ...
      if (profile) {
        reset({
          ...
          resume: null, // File input won't be set this way; handle it separately
        });
      }
    } catch (error) {
        ...
        <div className="md:col-span-2 p-5">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-transparent">Save</label>
                <button
                  type="submit"
                  className="w-full h-[47px] bg-blue-400 p-2 border border-gray-300 rounded"
                  disabled={loading}
                >
