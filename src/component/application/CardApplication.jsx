      ...
      <div className="bg-white border border-tertiary-ghost-color rounded-md">
        <div className="bg-gray-200 flex">
          <div className="px-4 py-2 flex gap-1 flex-grow text-lg">
            <Link
              to={`${urlPage.JOB_DETAIL}/${job.jobId}`}
              className="text-left font-medium hover:underline hover:text-primary- cursor-pointer"
            >
              {job.title}
            </Link>
          </div>
            ...
            <div className="p-2 flex border-r-2 border-gray-300">
              <div className="flex">
                <button className="text-primary-color my-auto h-6 flex gap-1 rounded px-2">
                  ...
                  <span className="hidden sm:block my-auto font-medium uppercase">
                    Message
                  </span>
                </button>
              </div>
        ...
        <div className="flex gap-1 border-none text-gray-500 rounded-b-lg">
          <select
            name=""
            id=""
            className="w-full p-3 outline-none rounded-b-lg  cursor-pointer border-none"
          >
