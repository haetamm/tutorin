...
const Sidebar = () => {
    return (
        <>
        <div className="flex fixed flex-col items-center w-40 h-full overflow-hidden text-gray-700 bg-gray-100 mt-[55px] md:mt-[58px]">
            ...
            <div className="w-full px-2">
                <div className="flex flex-col items-center w-full mt-3 border-t border-gray-300">
                    <a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" href="#">
                        ...
                        <span className="ml-2 text-sm font-medium">Job</span>
                    </a>
                    <a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" href="#">
                        <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
