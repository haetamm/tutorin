...
const Messages = () => {
  ...
  const getMessagePath = (index) => {
    if (role === 'student') {
      ...
      return isMobile
        ? `${urlPage.TUTOR_MESSAGE_MOBILE}/${index + 1}`
        : `${urlPage.TUTOR_MESSAGE}/${index + 1}`;
    }
    return '#';
  };
                ...
                <div className="flex flex-col h-screen w-full">
                  ...
                  <div className="flex-grow overflow-y-auto">
                    {[...Array(30)].map((_, index) => {
                      const path = getMessagePath(index);
                      ...
                      return (
                        <Link to={path} key={index} className="cursor-pointer">
                          ...
                          >
                            <button className="w-full bg-white border-l-4 border-primary-color">
